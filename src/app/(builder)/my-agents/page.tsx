          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="space-y-8">
              ...
              <div className="text-center space-y-4">
                <h1 className="text-4xl font-bold text-green-100 font-mono">My AI Agents</h1>
                <p className="text-green-300/80 font-mono text-lg">
                  Select an agent to chat with or create a new one
                </p>
              ...
              <div className="bg-gray-900/50 border border-gray-700 rounded-2xl p-6">
                <h2 className="text-xl font-bold text-gray-100 font-mono mb-6 flex items-center gap-2">
                  <span>🤖</span>
