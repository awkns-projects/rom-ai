...
export const facial_right_stylemap = [
...
export const facial_right_feature: CharacterFeature = {
  [CHARACTER_FACIAL_RIGHT_TYPE.NONE]: {
    variant: CHARACTER_FACIAL_RIGHT_TYPE.NONE,
    stylemap: [],
    required: {},
  },
  [CHARACTER_FACIAL_RIGHT_TYPE.MONOCLE]: {
    variant: CHARACTER_FACIAL_RIGHT_TYPE.MONOCLE,
    stylemap: facial_right_stylemap,
    required: {
...
export const facial_right_trim_stylemap = [
...
export const facial_right_trim_feature: CharacterFeature = {
  [CHARACTER_FACIAL_RIGHT_TRIM_TYPE.NONE]: {
    variant: CHARACTER_FACIAL_RIGHT_TRIM_TYPE.NONE,
    stylemap: [],
    required: {},
  },
  [CHARACTER_FACIAL_RIGHT_TRIM_TYPE.MONOCLE]: {
    variant: CHARACTER_FACIAL_RIGHT_TRIM_TYPE.MONOCLE,
    stylemap: facial_right_trim_stylemap,
    required: {
      [CHARACTER_FEATURE.FACIAL_RIGHT]: [CHARACTER_FACIAL_RIGHT_TYPE.MONOCLE],
    },
  },
};
